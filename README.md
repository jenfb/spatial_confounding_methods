...
Output was generated with R version 3.6.0 (2019-04-26).
...
```
## # A tibble: 5 x 4
##   method inference varies      value_seq                   
##   <chr>  <chr>     <chr>       <chr>                       
## 1 NS     freq      <NA>        <NA>                        
## 2 fix_df freq      DF          5, 10, 25, 50, 100, 250, 500
## 3 PS     freq      n_dim       500                         
## 4 EPS    freq      n_dim       500                         
## 5 NNGP   bayes     n_neighbors 5
```
...
For illustration, here we generate a single dataset from one set of parameter values. To save computation time for this illustration we generate a dataset of size 1000 (in the paper we used 2500). The parameter values we use are:
...
```
## # A tibble: 1 x 5
##   n_obs phi_c phi_u sigsq_x_true beta_true
##   <dbl> <dbl> <dbl>        <dbl>     <dbl>
## 1  1000  0.04   0.6          0.5         3
```
...
##  2 fix_df         5     3.59                  0.113     5            0.09
##  3 fix_df        10     3.53                  0.118    10            0.08
##  4 fix_df        25     3.46                  0.12     25            0.1 
##  5 fix_df        50     3.37                  0.124    50            0.17
##  6 fix_df       100     3.09                  0.13    100            0.3 
##  7 fix_df       250     2.87                  0.149   250            1.2 
##  8 fix_df       500     2.69                  0.187   500            4.08
##  9 PS           500     3.51                  0.116    16           17.1 
## 10 EPS          500     3.16                  0.129   146           18.0 
## 11 NNGP          NA     3.4                   0.113    NA           17.0
```
